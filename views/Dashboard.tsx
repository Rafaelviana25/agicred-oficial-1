                    ...
                    {!isPro && clients.length >= clientLimit && (
                      <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-3xl p-8 lg:p-10 shadow-lg text-white relative overflow-hidden mb-6">
                        ...
                        <div className="relative z-10">
                          <h3 className="text-xl lg:text-2xl font-black uppercase tracking-tight mb-3 flex items-center gap-3"><Crown size={28} className="fill-white"/> LIMITE ATINGIDO</h3>
                          <p className="text-sm lg:text-base font-medium opacity-90 mb-6 leading-relaxed max-w-2xl">
                          ...
                          <button onClick={() => setShowUpgrade(true)} className="bg-white text-violet-600 px-8 py-4 rounded-2xl text-xs lg:text-sm font-black uppercase tracking-widest shadow-md hover:bg-violet-50 transition-all active:scale-95 flex items-center gap-2">
                            QUERO SER PRO <ArrowRight size={18}/>
                          </button>
                        </div>
                      </div>
                    )}
