...
Pelo menos um número (0 a 9)`;
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center p-4 uppercase overflow-hidden relative font-bold text-slate-900">
      ...
      <div className="max-w-xs w-full glass-panel rounded-[2.5rem] p-8 space-y-8 animate-in fade-in zoom-in duration-700 relative z-10">
        <div className="text-center space-y-1">
          <AgicredLogo className="mx-auto" />
          <div className="h-1 w-8 bg-violet-500 mx-auto rounded-full mt-3 opacity-60"></div>
        </div>

        {error && (
          <div className="bg-rose-50 text-rose-600 p-3 rounded-xl text-[8px] font-black border border-rose-200 uppercase tracking-widest text-center leading-tight">
            {error}
          </div>
        )}
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                type="email" required
                className="w-full pl-11 pr-5 py-4 glass-input rounded-2xl focus:ring-1 focus:ring-violet-500 transition text-slate-900 font-bold text-[11px] outline-none placeholder:text-slate-400 lowercase"
                placeholder="e-mail"
          ...
          <div className="space-y-1.5">
            ...
            <div className="relative">
              ...
              <input
                type={showPassword ? "text" : "password"} required
                className="w-full pl-11 pr-12 py-4 glass-input rounded-2xl focus:ring-1 focus:ring-violet-500 transition text-slate-900 font-bold text-[11px] outline-none placeholder:text-slate-400"
                placeholder="••••••••"
          ...
          <div className="flex items-center justify-between px-1">
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className={`w-4 h-4 rounded border transition-all flex items-center justify-center ${rememberMe ? 'bg-violet-500 border-violet-500' : 'border-slate-300 bg-slate-50'}`}>
              ...
              />
              <span className="text-[8px] font-black text-slate-500 group-hover:text-slate-700 tracking-widest">LEMBRAR USUÁRIO</span>
            </label>
            
            <button 
              type="button"
              onClick={() => setMode('forgot')}
              className="text-[8px] font-black text-violet-600 hover:text-violet-500 tracking-widest"
            >
              ESQUECI MINHA SENHA
            </button>
          </div>
          ...
          <button
            type="submit" disabled={loading}
            className="w-full primary-gradient text-white py-4.5 rounded-2xl font-black text-[10px] uppercase tracking-[0.2em] shadow-xl hover:shadow-violet-500/25 transition-all active:scale-[0.98] flex items-center justify-center gap-2 group mt-4 h-14"
          >
        ...
        <div className="space-y-3 text-center">
          <button 
            ...
            className="text-slate-400 text-[8px] font-black uppercase tracking-widest hover:text-slate-900 transition-colors block mx-auto"
          >
            TROCAR DE SENHA
          </button>
          <button onClick={onSwitch} className="text-slate-400 text-[8px] font-black uppercase tracking-widest hover:text-slate-900 transition-colors">
