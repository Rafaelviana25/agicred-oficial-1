...
// Helper function to send OneSignal push notifications
async function sendOneSignalPush(title: string, body: string, playerId: string) {
...
async function startServer() {
  ...
  app.post('/api/test-push', async (req, res) => {
    // Removed check for firebaseInitialized as we are using OneSignal now
